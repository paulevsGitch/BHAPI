...
public class Textures {
	...
	static {
		...
		ID_BLOCK.put(81, Identifier.make("block/door_wood_upper"));
		ID_BLOCK.put(82, Identifier.make("block/door_iron_upper"));
		...
		ID_BLOCK.put(97, Identifier.make("block/door_wood_lower"));
		ID_BLOCK.put(98, Identifier.make("block/door_iron_lower"));
